...
parser.add_argument('--path', type=str, help='path to the dataset', default = '/home/ouc/Documents/dataset/train/')
parser.add_argument('--output', type=str, help='path to the file list' , default = '/home/ouc/Documents/dataset/val/')
